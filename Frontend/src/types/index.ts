...
// Canonical Domain types (EMR-agnostic)
export type {
  VisitType,
  CanonicalAnswerType,
  CanonicalValue,
...
// EMR Template types (vendor-specific mapping)
export type {
  HomeHealthEMRVendor,
  EMRTemplate,
  EMRTemplateSection,
  ...
  TemplateListItem,
  ExportPreview,
} from './emrTemplate.types';

export { HOME_HEALTH_EMR_VENDOR_CONFIG } from './emrTemplate.types';

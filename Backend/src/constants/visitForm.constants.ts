/**
 * Visit Form Configuration Constants
 *
 * Defines the discipline × visit type configuration matrix for dynamic visit documentation.
 * Each configuration specifies sections and questions based on:
 * - Discipline: RN, LVN, PT, OT, SLP, MSW, HHA
 * - Visit Purpose: SOC, ROC, RECERT, FOLLOWUP, DISCHARGE, EVALUATION
 */
...
export interface VisitFormQuestion {
  ...
  oasisMapping?: string; // Maps to OASIS item for integration
  validation?: {
    min?: number;
    max?: number;
    pattern?: string;
...
// =============================================================================
// COMMON SECTIONS (Reusable across disciplines)
// =============================================================================
...
export const VISIT_FORM_CONFIGS: VisitFormConfig[] = [
  ...
  // LVN Configurations (similar to RN but cannot do SOC/ROC)
  {
    discipline: 'LVN',
    visitPurpose: 'FOLLOWUP',
    requiresOasis: false,
